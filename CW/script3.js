...
function init() {
  ...
  audioLoader.load('sounds/Model 2/music.MP3', function (buffer) {
    sound.setBuffer(buffer);
    sound.setLoop(false);
    sound.setVolume(1.0);
  });
  audioLoader.load('sounds/Model 2/soundipods.MP3', function (buffer) {
  ...
  document.getElementById("switchModel").addEventListener('click', () => {
    loadModel('models/ipods.glb');
  });

  loadModel('models/IPOD.glb');
